...
public partial class Database_Output_User_MoneyInOut_Edit : GetTogether.Web.UI.Page
{
    public DO_User_MoneyInOut.UO_User_MoneyInOut UO;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (UO == null) UO = new DO_User_MoneyInOut.UO_User_MoneyInOut();
