...
public partial class Database_Output_ErrorDescrption_Edit : GetTogether.Web.UI.Page
{
    public DO_ErrorDescrption.UO_ErrorDescrption UO;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (UO == null) UO = new DO_ErrorDescrption.UO_ErrorDescrption();
