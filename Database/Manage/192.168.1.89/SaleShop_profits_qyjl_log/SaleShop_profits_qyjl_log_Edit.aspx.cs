...
public partial class Database_Output_SaleShop_profits_qyjl_log_Edit : GetTogether.Web.UI.Page
{
    public DO_SaleShop_profits_qyjl_log.UO_SaleShop_profits_qyjl_log UO;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (UO == null) UO = new DO_SaleShop_profits_qyjl_log.UO_SaleShop_profits_qyjl_log();
