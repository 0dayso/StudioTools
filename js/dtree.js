...
function dTree(objName,object_id,is_ajax,ajax_default,ajax_url,divAllID,min_height) {
	...
	this.icon = {
		...
		root				: SerUrl+'themes/skin-1'+FVersion+'/images/base.gif',

		folder: SerUrl + 'themes/skin-1' + FVersion + '/images/folder.gif',

		folderOpen: SerUrl + 'themes/skin-1' + FVersion + '/images/folderopen.gif',

		node: SerUrl + 'themes/skin-1' + FVersion + '/images/page.gif',

		empty: SerUrl + 'themes/skin-1' + FVersion + '/images/empty.gif',

		line: SerUrl + 'themes/skin-1' + FVersion + '/images/lineTree.gif',

		join: SerUrl + 'themes/skin-1' + FVersion + '/images/join.gif',

		joinBottom: SerUrl + 'themes/skin-1' + FVersion + '/images/joinbottom.gif',

		plus: SerUrl + 'themes/skin-1' + FVersion + '/images/plus.gif',

		plusBottom: SerUrl + 'themes/skin-1' + FVersion + '/images/plusbottom.gif',

		minus: SerUrl + 'themes/skin-1' + FVersion + '/images/minus.gif',

		minusBottom: SerUrl + 'themes/skin-1' + FVersion + '/images/minusbottom.gif',

		nlPlus: SerUrl + 'themes/skin-1' + FVersion + '/images/nolines_plus.gif',

		nlMinus: SerUrl + 'themes/skin-1' + FVersion + '/images/nolines_minus.gif'
	...
	if (min_height != null && min_height > 0) {
	...
	if(is_ajax)
	{
	   SetGetAllStyle(this.obj,this.divAllID,false);
	    ...
	    a(object_id,ajax_default,'',"get",EndInitTree,true,this); 
...
function EndInitTree(content,objId,args)
{
    ...
    for(var i=0;i<args.aNodes.length;i++)
    {
        if(args.is_ajax && args.aNodes[i].id!=0 && args.aNodes[i]._io==true && args.aNodes[i].hasRead==false)
        {
            ...
            a(args.object_id,args.ajax_url+"&folder="+args.aNodes[i].code,'',"get",EndGetTree,true,[args,args.aNodes[i].id]);
            break;
        }
    }
};
...
dTree.prototype.o = function(id) {
    ...
    if(!cn.hasRead && this.is_ajax)
    {
        ...
        a(this.object_id,this.ajax_url+"&folder="+cn.code,'',"get",EndGetTree,true,[this,id]);         
    }
};
...
function EndGetTree(content,objId,args)
{
    ...
    for(var i=0;i<dtInstance.aNodes.length;i++)
    {
        ...
        if((dtInstance.is_ajax && dtInstance.aNodes[i].id!=0 && dtInstance.aNodes[i].isParent&&dtInstance.aNodes[i]._io==true && dtInstance.aNodes[i].hasRead==false) || (dtInstance._ol==true && dtInstance.aNodes[i]._io==false)||(dtInstance.aNodes[i]._io==true&&!dtInstance.aNodes[i].hasRead))
        {
            ...
            a(dtInstance.object_id,dtInstance.ajax_url+"&folder="+dtInstance.aNodes[i].code,'',"get",EndGetTree,true,[dtInstance,dtInstance.aNodes[i].id]);
            break;         
        }
        ...
        for (var n=0; n<this.aNodes.length; n++)
         {
            if(status==true)
            {
                if (this.aNodes[n]._hc && this.aNodes[n].pid != this.root.id && this.aNodes[n]._io==false && !this.aNodes[n].hasRead) 
                {
                    ...
                    a(this.object_id,this.ajax_url+"&folder="+this.aNodes[n].code,'',"get",EndGetTree,true,[this,this.aNodes[n].id]);
